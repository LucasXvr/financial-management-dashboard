...
export default function Header() {
  ...
  return (
    <header className="bg-green-800 dark:bg-gray-800 text-white p-4 transition-colors duration-200">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center">
          <img src="/icone.png" alt="FinTrack Logo" className="h-8 w-auto mr-2" />
